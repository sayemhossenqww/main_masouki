...
<footer class="bg-body text-lg-start border-top text-center shadow-sm"
  ...
  <div class="container p-4">
    ...
    <div class="mb-3 text-center">
      <img src="<?php echo e(asset('images/webp/qr-code.webp')); ?>" class="rounded-main" height="200" alt="SpecialBites">
    </div>
    <div class="mb-3">
...
<!-- Footer -->
<?php /**PATH /Users/sayemh/Downloads/main_spb 2/resources/views/layouts/footer.blade.php ENDPATH**/ ?>