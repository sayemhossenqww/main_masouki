...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="menu-item <?php if(is_null($item->image_path)): ?> _without-image <?php endif; ?>">
            <?php if(!is_null($item->image_path)): ?>
...
<?php echo $__env->make('layouts.app_v2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Administrator\Desktop\Caliburger&QR\resources\views/home/v2/category.blade.php ENDPATH**/ ?>