        ...
        <ul class="navbar-nav mx-auto">
            <li class="nav-item">
                <a class="navbar-brand font-cinzel text-decoration-none fw-semi-bold fs-4 m-0"
                    ...
                    <img src="<?php echo e(asset('images/webp/logo-header.webp')); ?>" alt="The Bruvs" height="35">
                </a>
            </li>
        </ul>
...
<?php /**PATH C:\Users\Administrator\Desktop\Caliburger&QR\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>