...
<?php $__env->startSection('content'); ?>
    <div class="row mb-3">
                    ...
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-2 p-3 text-lg-center">
                                <img src="<?php echo e(asset('images/webp/pin.webp')); ?>" alt="Pin" height="38">
                            </div>
                            <div class="col-10">
                                <h5>Location</h5>
                                <a href="<?php echo e(config('app.location_to_go')); ?>" class="link-primary">
                                    <?php echo e(config('app.location')); ?>

                                    <br>
                                    <span lang="ar">
                                        <?php echo e(config('app.location_ar')); ?>
            ...
            <div class="col-12 d-flex align-items-stretch  p-3">
                <div class="card shadow-sm w-100 rounded-main">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-2 p-3 text-lg-center">
                                <img src="<?php echo e(asset('images/webp/phone-call.webp')); ?>" alt="Phone" height="38">
                            </div>
                            <div class="col-10">
                                <h5>Call Us</h5>
                                <a href="tel:<?php echo e(config('app.phone_to_call')); ?>" class="link-primary">
            ...
            <div class="col-12 d-flex align-items-stretch  p-3">
                <div class="card shadow-sm w-100 rounded-main">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-2 p-3 text-lg-center">
                                <img src="<?php echo e(asset('images/webp/letter.webp')); ?>" alt="letter" height="38">
                            </div>
                            <div class="col-10">
                                <h5>Email</h5>
                                <a href="mailto:<?php echo e(config('app.email')); ?>" class="link-primary">
        ...
        <div class="col-md-6">
            <img src="<?php echo e(asset('images/webp/the_bruvs.webp')); ?>" alt="SpecialBites" class="w-100 rounded-main shadow-sm">
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/caliisbw/special-bites.com/resources/views/contact/show.blade.php ENDPATH**/ ?>