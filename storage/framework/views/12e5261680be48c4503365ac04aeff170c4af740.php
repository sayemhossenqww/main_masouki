                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('home')); ?>">
                                    <mt-icon icon="storefront" styleName="me-2"></mt-icon> <?php echo app('translator')->get('The Bruvs'); ?>
                                </a>
                            </li>
                            <li>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Administrator\Desktop\Caliburger&QR\resources\views/admin/layouts/navbar.blade.php ENDPATH**/ ?>