...
<?php $__env->startSection('content'); ?>
    <div><strong><span>Terms and
                conditions</span></strong>
        <p>----</p>
        <p><strong>OVERVIEW</strong></p>
        <p>By visiting our site or app and/ or ordering something from us, you engage in our “Service” and agree to be bound
            by the following terms and conditions (“Terms of Service”, “Terms”). These Terms of Service apply &nbsp;to all
        ...
        <p>Please read these Terms of Service carefully before accessing or using our website. By accessing or using any
            ...
            conditions of this agreement, then you may not access the website or use our apps.</p>
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 1 - ONLINE ORDERING TERMS</strong></p>
        ...
        <p>The headings used in this agreement are included for convenience only and will not limit or otherwise affect
            these Terms. </p>
        <p>&nbsp;</p>
        <p><strong>SECTION 3 - MODIFICATIONS TO THE SERVICE AND PRICES </strong></p>
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 4 - PRODUCTS OR SERVICES </strong></p>
        <p>Certain products or services may be available exclusively online through the online ordering platforms. These
            products or services may have limited quantities.</p>
        ...
        <p>We reserve the right, but are not obligated, to limit the sales of our products or Services to any person,
            ...
            prohibited. </p>
        <p>&nbsp;</p>
        <p><strong>SECTION 5 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</strong></p>
        <p>We reserve the right to refuse any order you place with us. </p>
        <p>You agree to provide current, complete and accurate purchase and account information for all purchases made on
            our platforms. You agree to promptly update your account and other information, including your email address.
        </p>
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 7 - PERSONAL INFORMATION</strong></p>
        ...
        <p>Occasionally there may be information on our site or in the Service that contains typographical errors,
            inaccuracies or omissions that may relate to product descriptions, pricing, promotions, offers, product delivery
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 8 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY </strong></p>
        ...
        <p>In no case shall we, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers,
            ...
            (including negligence), strict liability or otherwise, arising from your use of any of the service or any
            ...
            otherwise made available via the service, even if advised of their possibility. </p>
        <p>&nbsp;</p>
        <p><strong>SECTION 9 - INDEMNIFICATION </strong></p>
        <p>You agree to indemnify, defend and hold us harmless and our parent, subsidiaries, affiliates, partners, officers,
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 11 - TERMINATION </strong></p>
        ...
        <p>&nbsp;</p>
        <p><strong>SECTION 12 - CHANGES TO TERMS OF SERVICE </strong></p>
        ...
        <p>We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by
            posting updates and changes. It is your responsibility to check periodically for changes. Your continued use of
            or access to our platforms or the Service following the posting of any changes to these Terms of Service
            constitutes acceptance of those changes.</p>
</div><?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/caliisbw/special-bites.com/resources/views/terms-and-conditions/show.blade.php ENDPATH**/ ?>